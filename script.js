    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "להיפטר מסוכרת ב-21 יום משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: 'e6238116-6b6b-48d1-be80-e1e17dffe4c2',
                        name: data.name,
                        email: data.email,
